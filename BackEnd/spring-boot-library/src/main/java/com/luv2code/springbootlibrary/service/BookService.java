...
public class BookService {
    ...
    public Book checkoutBook(String userEmail , Long bookId) throws Exception{
        ...
        if (!book.isPresent() || validateCheckout!=null || book.get().getCopiesAvailable() <=0){
            throw new Exception("Book doesn't exist or is checked out by other user");
        }
        ...
        for(Book book : books){
            ...
            if (checkout.isPresent()) {
                ...
                long difference_In_Time = time.
                        convert(d1.getTime() - d2.getTime() , TimeUnit.MILLISECONDS) ;
    ...
    public void returnBook(String userEmail , Long bookId) throws Exception {
        ...
        if(!book.isPresent() || validateCheckout == null) {
            throw new Exception("Book does not exist or is not checked out by you ");
        }
    ...
    public void renewLoan(String userEmail , Long bookId) throws Exception {
        ...
        if(d1.compareTo(d2) > 0 || d1.compareTo(d2) == 0 ){
            ...
            throw new Exception("Books cannot be renewed Past due Date!");
        }
    }
}
